...
2. Domain Layer: Contains entities, enums, event, and repositories - the core business model
3. Application Layer: DTOs, mappers, listener and service interfaces/implementations for business logic
